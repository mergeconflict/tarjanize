...
pub struct Summary {
    ...
    #[serde(rename = "total_cost_ms", with = "serde_duration")]
...
pub struct TargetData {
    ...
    pub name: String,
    /// Earliest start time.
    #[serde(rename = "start", with = "serde_duration")]
    pub start: Duration,
    /// Completion time (`start + cost`).
    #[serde(rename = "finish", with = "serde_duration")]
    pub finish: Duration,
    /// Predicted compilation cost.
    #[serde(rename = "cost", with = "serde_duration")]
    pub cost: Duration,
    /// How much this target can slip without affecting critical path.
    #[serde(rename = "slack", with = "serde_duration")]
    pub slack: Duration,
